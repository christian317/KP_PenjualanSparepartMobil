                ...
                <div class="card border-0 shadow-sm rounded-3">
                    ...
                    <div class="card-body p-4">
                        <div class="row g-3">
                            ...
                            {{-- STATUS BENGKEL --}}
                            <div class="col-md-12" id="field_bengkel">
                                <label class="form-label fw-semibold small text-secondary">Status Bengkel</label>
                                <select name="status_mitra" id="status_mitra" class="form-select rounded-3">
...
<script>
    ...
    function toggleForm() {
        ...
        // Tampilkan/Sembunyikan kolom khusus Pelanggan
        ...
        // Tampilkan/Sembunyikan kolom khusus Admin
