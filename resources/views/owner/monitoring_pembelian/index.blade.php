...
@section('content')
    <div class="p-4" style="background-color: #f8f9fa; min-height: 100vh;">
            ...
            <div class="d-flex justify-content-between align-items-start flex-wrap gap-3">
                <div>
                    <div class="h4 fw-bold mb-1 d-flex align-items-center">
                        <i class="bi bi-box-arrow-in-down me-2" style="color: #1565c0;"></i>Monitoring Pembelian Stok
                    </div>
        ...
        <form action="{{ route('owner.monitoring_pembelian.index') }}" method="GET"
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('owner.monitoring_pembelian.index') }}" class="btn btn-light border btn-sm px-2 text-secondary"
                    title="Reset Filter">
                            ...
                            <table class="table table-hover table-borderless align-middle mb-0">
                                ...
                                <tbody class="small">
                                    @foreach ($p->details as $det)
                                        <tr>
                                            <td class="ps-3 py-3">
                                                <code class="text-secondary fw-bold">SKU: {{ $det->produk->id }}</code>
                                            </td>
