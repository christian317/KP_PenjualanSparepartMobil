    ...
    <div class="col px-4 pt-4 pb-5 bg-light min-vh-100">
        ...
        <div class="sticky-top py-3 mb-4"
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h4 class="fw-bold mb-0 text-dark">Edit Brand</h4>
        ...
        <div class="row g-4">
            <div class="col-md-8">
                <div class="card border-0 shadow-sm rounded-3">
                    ...
                    <form method="POST" action="{{ route('admin.produk.brand.update', $brand->id) }}">
                        @csrf
                        <div class="card-body p-4">
                            <div class="row g-3">
                                <div class="col-md-8">
                                    <label class="form-label fw-semibold small text-secondary">Nama Brand</label>
                                    <input name="nama" type="text" value="{{ $brand->nama }}" class="form-control rounded-3 py-2" required>
                                </div>
                                <div class="col-12">
                                    <label class="form-label fw-semibold small text-secondary">Deskripsi Produk</label>
                                    <textarea name="deskripsi" type="text" class="form-control rounded-3" rows="3">{{ $brand->deskripsi }}</textarea>
                                </div>
                            </div>
                            <div class="d-grid gap-2" style="margin-top: 15px">
                                <button type="submit" class="btn btn-danger py-2 fw-bold rounded-3 shadow-sm border-0"
                                    ...
                                    <i class="bi bi-check-circle me-2"></i>Edit Brand
                                </button>
                            </div>
                        </div>
                </div>
