...
Route::middleware(['role:admin_gudang'])->group(function () {
    ...
    Route::get('/admin/produk/delete/{id}', [ProdukController::class,'delete'])->name('admin.produk.delete');
...
Route::middleware(['role:admin_owner'])->group(function () {
    ...
    Route::post('/owner/riwayat_pesanan/{nomor_pesanan}/approve-refund', [RiwayatPesananController::class, 'approve_refund'])->name('owner.riwayat_pesanan.refund.approve');
    Route::post('/owner/riwayat_pesanan/{nomor_pesanan}/tolak-refund', [RiwayatPesananController::class, 'tolak_refund'])->name('owner.riwayat_pesanan.refund.tolak');
});
